            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form permission="form" id="addPermission" action="addNewPermission" method="post" permission="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
<script src="<?php echo base_url(); ?>assets/js/addPermission.js" type="text/javascript"></script>